                                        ...
                                        <?php $cnt = 1; foreach ($records as $record) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo admin_url('powerform/download_job_application_pdf/' . $record['id']); ?>" class="btn btn-danger btn-xs" title="Download PDF"><i class="fa-solid fa-file-pdf"></i></a>
