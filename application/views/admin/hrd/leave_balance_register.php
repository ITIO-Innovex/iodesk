...
<div id="wrapper">
  <div class="content">
    <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700 tw-mb-2">
      <i class="fa-solid fa-calendar-check tw-mr-2"></i> Leave Balance Register
    </h4>
    <div class="row">
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body panel-table-fullxx">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div>
                      ...
                      <a href="<?php echo admin_url('hrd/leave_balance_register'); ?>" class="btn btn-default" title="Reset"><i class="fa-solid fa-xmark"></i> Reset</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            ?>
              <div class="alert alert-info">
                ...
                Leave Balance Register for <strong><?php echo e($first_reg['staff_name']); ?></strong>
