...
<a href="#" class="btn btn-warning pull-right lead-top-btn" onclick="alert('Already converted to deal')" ><i class="fa-solid fa-handshake"></i> Deal</a><?php */?><?php } ?></div>
    ...
    // For Merged Leads
        if($lead->merged_lead_ids && !empty($lead->merged_lead_ids)){
            ...
            echo "<span class='field-selected-primary'> (Merged)</span><span>";
    ...
    // For Child Leads
        if($lead->is_child == 1){
            echo "<span class='field-selected-primary'> (Child)</span>";
...
<span class="tw-text-sm tw-text-neutral-500" style="color:<?php echo $task_bg;?>"> To Do Time : <?php echo $task['date']; ?> To Do Added on : <?php echo $task['dateadded']; ?> </span>
				...
				<div role="tabpanel" class="tab-pane" id="tab_leads_conversions">
					...
					<div class="col-md-12">
						...
						<div class="text-right">
							<button id="send_telegram_conv" data-url="/iodesk/telegram.php" class="btn btn-primary"><?php echo _l('send'); ?></button>
						</div>
					</div>
				</div>
				<?php } ?>
