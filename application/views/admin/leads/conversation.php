...
function getWebChat(name,chatId){
	...
	$.ajax({
		type: "POST",
		url: "/iodesk/show-webchat-discuss.php",
		data: { chat_id: chatId }
	}).done(function(data) {
//			alert(1111+data);
...
function sendMessage() {
	...
	if (message) {
		...
		xhr.open("POST", "/iodesk/show-webchat-discuss.php", true); // The PHP file is called discuss page
...
function sendTelegramMessage() {
	...
	if (message) {
		...
		// Perform AJAX request to send the message
		var xhr = new XMLHttpRequest();
		xhr.open("POST", "/iodesk/show-telegram-discuss.php", true); // The PHP file is called show-telegram-discuss.php
		xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
