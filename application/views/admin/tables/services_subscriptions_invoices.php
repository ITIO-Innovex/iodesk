...
$join = [];
$additionalSelect = ['payment_method'];
...
foreach ($rResult as $aRow) {
    ...
    $options .= '<a href="' . admin_url('services/subscriptions_invoices/delete/' . $aRow['id']) . '" class="tw-mt-px tw-text-neutral-500 hover:tw-text-neutral-700 focus:tw-text-neutral-700 _delete"><i class="fa-regular fa-trash-can fa-lg"></i></a>';
    $options .= '</div>';
