    ...
    <div class="modal-content">
      ...
      <form id="dmForm">
        <div class="modal-body">
            ...
            <select class="form-select wa-form-select message-field" id="dmTempMessage" aria-label="Default select example">
                    <option selected> Open this select menu</option>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(response.type== 1){
                    ...
                    messageDiv = $(`<div class="sent-message message_formating" id="${messageData.id}">
                            <div>${message}</div>
                            <div class="chat-time">${formattedTime} ${tickIcon}</div>
                        </div>`);
                }
...
$(document).ready(function() {
    $('#dmForm').on('submit', function(e) {
        ...
        const dmTemplate = $('#dmTempMessage').val();
        const source = "crm";
