                    ...
                    <div class="card-body ">
                        ...
                        <table class="table table-clients number-index-2 dataTable no-footer">
                            ...
                            <tr role="row">
                                ...
                                <th class="toggleable">Company Id</th>
                    ...
                    <div class="form-group">
                        ...
                        <select name="company" id="company" class="form-control">
                            ...
                            <?php foreach($company_list as $cc){ ?>
                                <option value="<?= $cc['company_id'] ?>"><?= $cc['companyname'] ?></option>
                            <?php } ?>
                        </select>
                    </div> 
                <?php } ?>
...
<script>
    ...
    const isAdmin = <?php echo is_admin() ? 1 : 0; ?>;
    const isSuper = <?php echo is_super() ? 1 : 0; ?>;
    if(isSuper){
        formData.companyId = $('#company').val();
    }
    if(isAdmin){
