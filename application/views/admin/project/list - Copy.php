          ...
          <div class="col-md-12">
			...
			<div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="tags" name="tags" placeholder="<?php echo _l('Enter a tag name'); ?>">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php /*?><div class="form-group">
              ...
              <input type="text" class="form-control" id="edit_tags" name="tags" placeholder="Enter a tag name">
...
function initializeTagsInput() {
    console.log('Tags input function called');
    var $tagsInput = $('#tags');
    var $tagsContainer = $('#tags-container');
    
    console.log('Tags input element:', $tagsInput.length);
    console.log('Tags container element:', $tagsContainer.length);
    
    // Clear any existing event handlers
    $tagsInput.off('keydown.tags').off('blur.tags');
    
    $tagsInput.on('keydown.tags', function(e) {
    ...
    $tagsInput.on('blur.tags', function() {
        if ($(this).val().trim()) {
            addTag();
        }
    });
    ...
    function addTag() {
        ...
        if (tagText && projectTags.indexOf(tagText) === -1) {
            projectTags.push(tagText);
            console.log('Tags array:', projectTags);
            renderTags();
            $tagsInput.val('');
        }
    }
    ...
    function removeTag(tagText) {
        var index = projectTags.indexOf(tagText);
        if (index > -1) {
    ...
    function renderTags() {
        ...
        projectTags.forEach(function(tag) {
            var $tag = $('<span class="tag-item">' + tag + '<span class="tag-remove">×</span></span>');
