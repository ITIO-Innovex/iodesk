      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body mail-bg">
            ...
            <?php echo form_open(base_url('forms/job_application_form_submit'), ['id' => 'job-application-form']); ?>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="applied_post" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Mobile No : <small class="req text-danger">* </small></label>
                    <input type="text" name="mobile_no" class="form-control" maxlength="10" pattern="\d{10}" inputmode="numeric" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Alternative No : </label>
                    <input type="text" name="alternative_no" class="form-control" maxlength="10" pattern="\d{10}" inputmode="numeric" value="">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="address_with_pincode" class="form-control" rows="3" required></textarea>
                  </div>
                </div>
              </div>
              </div>
...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Name of Board/University</th>
  ...
  <?php for ($i = 1; $i <= 5; $i++): 
				...
				?>
  <tr>
      <th><input type="text" name="edu<?php echo $i; ?>_degree" class="form-control" value="" <?php echo $req;?>></th>
      <td><input type="text" name="edu<?php echo $i; ?>_university" class="form-control" value="" <?php echo $req;?>></td>
      <td><input type="text" name="edu<?php echo $i; ?>_major_subject" class="form-control" value="" <?php echo $req;?>></td>
      <td><input type="text" name="edu<?php echo $i; ?>_year" class="form-control" value="" <?php echo $req;?>></td>
    </tr>
  <?php endfor; ?>
  </tbody>
</table>
...
<table class="table">
  ...
  <?php for ($i = 1; $i <= 6; $i++): 
				...
				?>
  <tr>
      <th><input type="text" name="fam<?php echo $i; ?>_name" class="form-control" value="" <?php echo $req;?>></th>
      <td><input type="number" name="fam<?php echo $i; ?>_age" class="form-control" value="" <?php echo $req;?>></td>
      <td><input type="text" name="fam<?php echo $i; ?>_relationship" class="form-control" value="" <?php echo $req;?>></td>
      <td><input type="text" name="fam<?php echo $i; ?>_occupation" class="form-control" value="" <?php echo $req;?>></td>
    </tr>
  <?php endfor; ?>
  </tbody>
</table>
			  ...
			  <div class="row">
<div class="col-md-12"><h5>Professional Work Experience Details:(Current 2 Employers Details)</h5></div>
                <?php for ($i = 1; $i <= 2; $i++): ?>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Job Title #<?php echo $i; ?> : <small class="req text-danger">* </small></label>
                    <input type="text" name="job<?php echo $i; ?>_title" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Start Date : <small class="req text-danger">* </small></label>
                    <input type="date" name="job<?php echo $i; ?>_start_date" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>End Date : <small class="req text-danger">* </small></label>
                    <input type="date" name="job<?php echo $i; ?>_end_date" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Company : <small class="req text-danger">* </small></label>
                    <input type="text" name="job<?php echo $i; ?>_company" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Designation : <small class="req text-danger">* </small></label>
                    <input type="text" name="job<?php echo $i; ?>_designation" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Reason for Leaving : <small class="req text-danger">* </small></label>
                    <input type="text" name="job<?php echo $i; ?>_reason_for_leaving" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Start Salary : <small class="req text-danger">* </small></label>
                    <input type="text" name="job<?php echo $i; ?>_start_salary" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label>End Salary : <small class="req text-danger">* </small></label>
                    <input type="text" name="job<?php echo $i; ?>_end_salary" class="form-control" value="" required>
                  </div>
                </div>
                <?php if ($i < 2): ?>
...
<div class="col-md-12"><h4 class="text-success">Additional Information</h4></div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="linkedin_connections" class="form-control" value="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Major Skill 1 : <small class="req text-danger">* </small></label>
                    <input type="text" name="major_skill_1" class="form-control" value="" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Major Skill 2 : <small class="req text-danger">* </small></label>
                    <input type="text" name="major_skill_2" class="form-control" value="" required>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="coordinating_person_name" class="form-control" value="">
                  </div>
                </div>
              </div>
              </div>
              ...
              <div class="tw-flex tw-gap-2">
                <button type="submit" class="btn btn-primary" data-status="Interviewed" id="save-interview">Submit</button>
