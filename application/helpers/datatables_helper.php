...
function render_datatable($headings = [], $class = '', $additional_classes = [''], $table_attributes = [])
{
    ...
    echo '<table ' . $_table_attributes . ' class="dt-table-loading table table-' . $class . $_additional_classes . '" style="display:blockVKG; overflow-x:auto; white-space:nowrap; max-width:100%;">';
