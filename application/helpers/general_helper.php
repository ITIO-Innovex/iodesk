...
function get_staff_companyid()
{
    ...
    return $CI->session->userdata('staff_company_id');
}
...
function is_super()
{
	...
	$staff_company_id=$CI->session->userdata('staff_company_id');
	$staff_user_id=$CI->session->userdata('staff_user_id');
	
	if(isset($staff_company_id)&&$staff_company_id&&isset($staff_user_id)&&$staff_user_id){
		
		if($staff_company_id==1 && $staff_user_id==1){
		return true;	
		}
